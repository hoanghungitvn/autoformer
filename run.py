...
def main():
    ...
    parser.add_argument('--model_id', type=str, required=False, default='MNKL_Informer', help='model id')
    parser.add_argument('--model', type=str, required=False, default='Informer',
                        help='model name, options: [Autoformer, Informer, Transformer]')

    # data loader
    parser.add_argument('--data', type=str, required=False, default='custom', help='dataset type')
    parser.add_argument('--root_path', type=str, default='X:\ATMEL\pythonProject', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='songhuong_mice.csv', help='data file')
    parser.add_argument('--features', type=str, default='M',
                        help='forecasting task, options:[M, S, MS]; M:multivariate predict multivariate, S:univariate predict univariate, MS:multivariate predict univariate')
    parser.add_argument('--target', type=str, default='MN_KimLong', help='target feature in S or MS task')
    ...
    parser.add_argument('--do_predict', type=int, required=False, default=1, help='whether to predict unseen future data')
    ...
    # forecasting task
    args.seq_len = 24 #input sequence length default=96
    args.label_len = 4 #start token length default=48
    ...
    args.e_layers = 2 #num of encoder layers,default=2
    args.d_layers = 1 #num of decoder layers, default=1
    args.n_heads = 8 #num of heads, default=8
    args.factor = 1 #attn factor,default=1
    args.d_model = 256 #dimension of model, default=512
    args.des = 'Exp'
    args.d_ff = 2048 #dimension of fcn, default=2048
